...
def run_with_temperature_concat(accelerator, model_name, input_text, temperature=0.5, contextual_embedding_extraction_form="last_token", middle=False, REVISIONS=143000):
...
def run_with_temperature(accelerator, model_name, input_text, temperature=0.5, contextual_embedding_extraction_form="last_token", middle=False, REVISION=143000):
