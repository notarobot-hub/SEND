...
wandb.init(project="mitigation-finetuning", config={
...
argument.add_argument("--run_number", type=int, default=0)
...
save_path = os.path.join(os.getenv('SCRATCH'), f"mitigation-finetuning-{run_number}-send")
