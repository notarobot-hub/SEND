...
wandb.init(project="pythia-sensitive-neurons-normal", config={
...
argument_parser.add_argument('--run_number', type=int, default=0)
...
# def compute_eigenscore(X, limit, alpha=0.001):
...
save_path = os.path.join(os.getenv('SCRATCH'), f"mitigation-finetuning-{run_number}-normal")
